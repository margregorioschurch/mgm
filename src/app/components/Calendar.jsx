...
export default function Calendar() {
  ...
  return (
    <section className="container py-10 px-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-center gap-2 mb-6 text-center">
            <FontAwesomeIcon icon={faCalendar} className="text-orange-400 text-lg" />
            <h5 className="text-primary font-secondary text-lg text-orange-400 font-semibold uppercase tracking-widest">
                Calendar
            </h5>
            
        </div>
        <h6 className="text-4xl font-bold text-center mt-1 mb-8">Calender Events</h6>

      <div id="calendar" ref={calendarRef} className="max-w-4xl mx-auto mt-3 p-2 border rounded shadow" />
      <div className="mt-6 flex flex-wrap justify-center gap-4">
        <a
          className="bg-blue-600 text-white py-1.5 px-4 rounded hover:bg-blue-700 transition"
          href="https://mosc.in/uploads/2023/12/Panjangom2025_Online.pdf"
          target="_blank"
